...
def main():
    ...
    parser.add_argument('--frames_dir', type=str, default='mini_project_loop_30fps/frames')
    parser.add_argument('--sea_dir', type=str, default='mini_project_loop_30fps/sea_input')
    parser.add_argument('--out_dir', type=str, default='mini_project_loop_30fps/output')
