...
def main():
    ...
    parser.add_argument('--fps', type=float, default=10.0, help='extract/output fps')
    parser.add_argument('--num_frames', type=int, default=20, help='total frames to generate')
    parser.add_argument('--frames_dir', type=str, default='mini_project_loop/frames')
    parser.add_argument('--sea_dir', type=str, default='mini_project_loop/sea_input')
    parser.add_argument('--out_dir', type=str, default='mini_project_loop/output')
